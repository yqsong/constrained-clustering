...
//			for (int mm = 0; mm < indices.length; ++mm) {
//				System.out.println("index: " + indices[mm] + " value: " + values[mm]);
//			}
	...
	public int[] laplacianScore(int numK, String type) {
		if (this.fMat == null) {
			logger.warning("No feature loaded");
			return null;
		}
...
//		double[] values = null;
		int neighborNum = 3;
		indices = ls.laplacianScore(neighborNum, "heat");
	}
